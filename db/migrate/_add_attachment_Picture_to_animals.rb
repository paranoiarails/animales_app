class AddAttachmentPictureToAnimals < ActiveRecord::Migration
  ...
  def self.down
    remove_column :animals, :Picture_file_name
    remove_column :animals, :Picture_content_type
    remove_column :animals, :Picture_file_size
    remove_column :animals, :Picture_updated_at
  end
end
